...
function setActiveList(list) {
  listStore.setActive(list.id);
}
</script>

<template>
  <div
      class="relative flex flex-col bg-clip-border rounded-xl w-1/3">
    <div class="max-w-[20rem] bg-white text-gray-700 h-[calc(100vh-2rem)] p-4 shadow-xl shadow-blue-gray-900/5">
